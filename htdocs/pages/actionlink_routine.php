...
// esta informacion la tenemos en nustro form 
// print_r($_POST);
$exercise = $_POST['exercise']; # ['exercise'] --> Este es el name='excercise' que tenemos en el <input> de nuestro Form.
$equipment = $_POST['equipment'];
$series = $_POST['series'];
$reps = $_POST['reps'];

$routineCreated = create_routine($dbConnect, $exercise, $equipment, $series, $reps);
...
<?php
    ...
    if ($routineCreated) {
        ...
        echo '<p>Routine successfully created</p><i class="fa fa-check-circle" style="color: green; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
     ...
     <!-- </div> EO WRAPPER-->';
        ...
        echo '<div style="display: flex; justify-content: center; align-items: center; height: 50vh; font-family: system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, sans-serif; color;font-size: 1.1em;">';
        echo '<p>Error creating routine!</p><i class="fa fa-times-circle" style="color: red; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
        // EO Error updating
        echo ' <!-- footer -->
        <footer>
