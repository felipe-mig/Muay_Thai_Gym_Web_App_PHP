...
//  STAFF TO ROUTINE ==> CHANGE THE BELOW CODE!!
...
$result = insert_staff_to_routine($dbConnect, $staffid, $exerciseid);
...
<body onload="bounce()">
<script>
    window.location.href = "view_staff_to_routine_table.php#pointer_staff_to_routine_view";
</script>
