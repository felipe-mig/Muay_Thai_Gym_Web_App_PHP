...
// Esta es la informacion que tenemos en nuestro <form>
// print_r($_POST);
$newreps = $_POST['newreps']; # name="" que tenemos en el <input> de nuestro <form>
$repsid = $_POST['repsid']; # name="" que tenemos en el <input> con el value="hidden"
update_reps($dbConnect, $repsid, $newreps);

// call the function and catch the result for the succsefull or error message
$updateSuccessful = update_reps($dbConnect, $repsid, $newreps);
