...
<body>
    <div class="wrapper">
        ...
        echo '<br id="pointer_members_to_routine_view">';
	    // home button	
        echo '<div class="arrrowgoback_container">';
        echo '<a id="gohome" href="dashboard.php"><i class="fa fa-home"></i></a>';
        echo '</div>';
        echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em; color:#757575;">Linked Members to Routines View</h4><br>';
        ...
        echo '<table class="users_table_view">
                ...
                view_members_to_routine_table($dbConnect);
        echo '</table>';
        // Add more links button at the end of table member to routine
        echo '<br>';
        echo '<form  class="options_buttons_tables" style="height: auto;" >';
            echo '<a id="addmoreicon" href="link_member_to_routine_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more links</a>';
        echo '</form>';
        echo '<br><br>';
        }
