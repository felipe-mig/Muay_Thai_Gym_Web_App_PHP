...
// print_r($_POST);
$className = $_POST['class']; # ['class_name'] --> Este es el name='class' que tenemos en el <input> de nuestro Form.
$day = $_POST['day_name'];
$time = $_POST['time_selection'];


$classCreated = create_class($dbConnect, $className, $day, $time);
...
<?php
    ...
    if ($classCreated) {
        ...
        echo '<p>Class successfully created</p><i class="fa fa-check-circle" style="color: green; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
     ...
     <!-- </div> EO WRAPPER-->';
        ...
        echo '<div style="display: flex; justify-content: center; align-items: center; height: 50vh; font-family: system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, sans-serif; color;font-size: 1.1em;">';
        echo '<p>error creating class!</p><i class="fa fa-times-circle" style="color: red; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
        // EO Error updating
        echo ' <!-- footer -->
        <footer>
...
<script>
    function bounce(){
        window.location.href = "dashboard.php#pointer_created_class_view";
    }
