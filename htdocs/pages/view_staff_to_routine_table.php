...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '<br id="pointer_staff_to_routine_view">';
	    // home button	
        ...
        echo '</div>'; 
        echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em; color:#757575;">Linked Staff to Routines View</h4><br>';
        ...
        view_staff_to_routine_table($dbConnect); 
        echo '</table>';
        echo '<br>';
        // Add more links button at the end of table
        echo '<form  class="options_buttons_tables" style="height: auto;" >';
        echo '<a id="addmoreicon" href="link_staff_to_routine_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more links</a>';
        echo '</form>';
        echo '<br>';
        echo '<br>';
        echo '<br>';
