...
<body>
    <div class="wrapper">
        ...
        echo '<br id="pointer_created_class_view">';
        echo '<div class="arrrowgoback_container">';
        echo '<a id="arrrowgoback" href="select_table_section.php"><i class="fa fa-arrow-circle-left"></i></a>';
        // Home button
        echo '<a id="gohome" href="dashboard.php"><i class="fa fa-home"></i></a>';
        echo '</div>';
                      // Created class view
                      echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em; color:#757575;">Class Timetable</h4><br>';
                      echo '<p class="ctrlplusf">* To search for a specific class press <span style="font-weight: bold;">Ctrl+F</span> and enter the name</p><br>';
                     echo '<table class="routine_table">
                      <tr>
                          <th>Class</th>
                          <th></th>
                          <th>day</th>
                      ...
                      view_created_class($dbConnect);
                     echo '</table>';
                     echo '<br>';
                     // Add more classes button at the end of table classes timetable
                     echo '<form  class="options_buttons_tables" style="height: auto;" >';
                         echo '<a id="addmoreicon" href="create_class_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more classes</a>';
                     echo '</form>';
        }
