...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '</div>';
                 // Create Class Form
                 echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Create Class</h4><br>';
                 echo '<form action="../pages/action_create_class.php" method="post">
                         <input name="class" type="text" placeholder="Enter Class">
                         <input name="day_name" type="text" placeholder="Enter day">
                         <input name="time_selection" type="time" placeholder="Enter time">
                         <div class="login-form-logo" style="margin-top: 9vh;"></div>
