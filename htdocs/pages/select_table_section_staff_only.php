...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            <a href="view_classes_table_staff_only.php" class="updatepassword-link">Classes</a>
            </div>
            ';
            // routines button
            echo '<br>';
            echo '
            <div class="adduser-container">
            <a href="view_routines_table_staff_only.php" class="updatepassword-link">Routines</a>
            </div>
            ';
            echo '<br>';
            ...
            echo '
            <div class="adduser-container">
            <a href="view_staff_to_member_staff_only.php" class="updatepassword-link">Staff to Member</a>
            </div>
            ';
            echo '<br>';
            ...
            echo '
            <div class="adduser-container">
            <a href="view_member_to_routine_table_staff_only.php" class="updatepassword-link">Member to Routine</a>
            </div>
            ';
            echo '<br>';
