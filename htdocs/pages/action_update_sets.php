...
// print_r($_POST);
$newset = $_POST['newset']; # name="" que tenemos en el <input> de nuestro <form>
$setid = $_POST['setid']; # name="" que tenemos en el <input> con el value="hidden"
update_sets($dbConnect, $setid, $newset);
