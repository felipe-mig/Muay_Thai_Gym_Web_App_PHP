...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            $userid = $_GET['username']; #name="" del <input>
            // UPDATE PASSWORD FORM
            echo '<br><br>';
            echo '<div class="arrrowgoback_container">';
            echo '<a id="arrrowgoback" href="dashboard.php"><i class="fa fa-arrow-circle-left"></i></a>';
            echo '</div>';
            echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Update Password</h4><br>';
            echo '
            <form action="../pages/action_update_users_password.php" method="post" style=" height: auto; text-align: center; font-family: system-ui;">
            <br>
            <label style="display: block; margin-top: 1vh;">User</label>
            ';
            // showMem();
           // $userid = $_SESSION['id'];
            dropdown_users($dbConnect, "username");
            // Udpate Password input
        echo '
