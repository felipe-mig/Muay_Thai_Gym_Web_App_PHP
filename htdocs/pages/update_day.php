...
<body>
    <div class="wrapper">
        ...
        // Aqui va el UX
        $dayid = $_GET['id']; # name="" del <input> En este caso ['id'] porque asi lo tengo en la funcion que llama a este row ($row['id']).
        ...
        echo '</div>';
        echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Update Day</h4><br>';
        echo '
        <form action="action_update_day.php" method="post" style=" height: auto; text-align: center; font-family: system-ui;">
        <input type="text" name="newday" placeholder="Enter New Day"> 
