...
// print_r($_POST);
$newday = $_POST['newday']; # name="" que tenemos en el <input> de nuestro <form>
$dayid = $_POST['dayid']; # name="" que tenemos en el <input> con el value="hidden"
update_day($dbConnect, $dayid, $newday);

// call the function and catch the result for the succsefull or error message
$updateSuccessful = update_day($dbConnect, $dayid, $newday);
