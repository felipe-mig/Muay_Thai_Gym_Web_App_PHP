...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '<a id="arrrowgoback" href="dashboard.php"><i class="fa fa-arrow-circle-left"></i></a>';
            echo '</div><br>';
            ...
            <a href="view_staff_table.php" class="updatepassword-link">Staff</a>
            </div>
            ';
            echo '<br>';
            // member button
            echo '
            <div class="adduser-container">
            <a href="view_members_table.php" class="updatepassword-link">Members</a>
            </div>
            ';
            // classes button
            echo '<br>';
            echo '
            <div class="adduser-container">
            <a href="view_classes_table.php" class="updatepassword-link">Classes</a>
            </div>
            ';
            // routines button
            echo '<br>';
            echo '
            <div class="adduser-container">
            <a href="view_routines_table.php" class="updatepassword-link">Routines</a>
            </div>
            ';
            echo '<br>';
            // staff to member button
            echo '
            <div class="adduser-container">
            <a href="view_staff_to_member_table.php" class="updatepassword-link">Staff to Member</a>
            </div>
            ';
            echo '<br>';
            // staff to class button
            echo '
            <div class="adduser-container">
            <a href="view_staff_to_class_table.php" class="updatepassword-link">Staff to Class</a>
            </div>
            ';
            echo '<br>';
            // staff to routine button
            echo '
            <div class="adduser-container">
            <a href="view_staff_to_routine_table.php" class="updatepassword-link">Staff to Routine</a>
            </div>
            ';
            echo '<br>';
            // member to routine button
            echo '
            <div class="adduser-container">
            <a href="view_member_to_routine_table.php" class="updatepassword-link">Member to Routine</a>
            </div>
            ';
            echo '<br>';
