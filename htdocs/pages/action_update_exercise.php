...
// print_r($_POST);
$newexercise = $_POST['newexercise']; # name="" que tenemos en el <input> de nuestro <form>
$exerciseid = $_POST['exerciseid']; # name="" que tenemos en el <input> con el value="hidden"
update_exercise($dbConnect, $exerciseid, $newexercise);

// call the function and catch the result for the succsefull or error message
$updateSuccessful = update_time($dbConnect, $timeid, $newtime);
