...
// print_r($_POST);
$newequipment = $_POST['newequipment']; # name="" que tenemos en el <input> de nuestro <form>
$equipmentid = $_POST['equipmentid']; # name="" que tenemos en el <input> con el value="hidden"
update_equipment($dbConnect, $equipmentid, $newequipment);

// call the function and catch the result for the succsefull or error message
$updateSuccessful = update_equipment($dbConnect, $equipmentid, $newequipment);
