...
<body>
    <div class="wrapper">
        ...
        // Home button
        echo '<br id="pointer_view_staff_to_member">';
        ...
        echo '<table class="users_table_view">
                   ...
                   viewstafftomember($dbConnect);
       echo '</table>';
       echo '<br>';
       // Add more links button at the end of table staff to member
       echo '<form  class="options_buttons_tables" style="height: auto;" >';
           echo '<a id="addmoreicon" href="link_staff_to_member_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more links</a>';
       // Home button
       echo '</form>';
        echo '<br>'; 
        echo '<br>'; 
