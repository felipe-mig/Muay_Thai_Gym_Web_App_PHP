...
<body>
    <div class="wrapper">
        ...
        // Aqui va el UX
        $classid = $_GET['id']; # name="" del <input> En este caso ['id'] porque asi lo tengo en la funcion que llama a este row ($row['id']).
        echo '<br><br>';
        echo '<div class="arrrowgoback_container">';
        echo '<a id="arrrowgoback" href="dashboard.php#pointer_created_class_view"><i class="fa fa-arrow-circle-left"></i></a>';
        echo '</div>';
        echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Update Class</h4><br>';
        
        echo '
        <form action="action_update_class.php" method="post" style=" height: auto; text-align: center; font-family: system-ui;">
        <input type="text" name="newclass" placeholder="Enter New Class"> 
