...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '</div>';
            echo '<h4 id="pointer_link_staff_to_member" style="text-align: center; font-family: system-ui; font-size: 1.2em;">Link Staff to Routine</h4><br>';
                // Link staff to routine form
                link_staff_to_routine($dbConnect, $users, $routine);
        }
