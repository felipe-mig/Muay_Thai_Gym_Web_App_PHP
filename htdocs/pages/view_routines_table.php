...
<body>
    <div class="wrapper">
        ...
        // routine table
                       // Create Routine Form
                       echo '<br id="pointer_routines_view">';
                       echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em; color:#757575;">Routines view</h4><br>';
                       echo '<p class="ctrlplusf">* To search for a specific routine press <span style="font-weight: bold;">Ctrl+F</span> and enter the name</p><br>';
                       ...
                       // Created Routine view
                       view_routine($dbConnect, $routine);
                       echo '</table>';
                       echo '<br>';
                           // Add more routines button at the end of table
                       echo '<form  class="options_buttons_tables" style="height: auto;" >';
                           echo '<a id="addmoreicon" href="create_routine_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more routines</a>';
