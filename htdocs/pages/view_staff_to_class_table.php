...
<body>
    <div class="wrapper">
        ...
        // Home button
        echo '<br id="pointer_staff_to_class_view">';
            ...
            echo '</div>'; 
                // Linked Staff to Class View
                echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em; color:#757575;">Linked Staff to Class View</h4><br>';
                ...
                echo '<table class="users_table_view">
                        ...
                        view_staff_to_class_table($dbConnect);  
                echo '</table>';
                echo '<br>';
                // Add more classes button at the end of table staff to class
                echo '<form  class="options_buttons_tables" style="height: auto;" >';
                    echo '<a id="addmoreicon" href="link_staff_to_class_section.php"><i class="fa fa-plus" style=" margin-right: 0.25vw;" ></i>Add more links</a>';
                // Home button  
                echo '</form>';
                echo '<br>';
        }
