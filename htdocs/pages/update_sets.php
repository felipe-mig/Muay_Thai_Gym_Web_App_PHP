...
<body>
    <div class="wrapper">
        ...
        // Aqui va el UX
        $setid = $_GET['id']; # name="" del <input> En este caso ['id'] porque asi lo tengo en la funcion que llama a este row ($row['id']).
        echo '<br><br>';
        ...
        echo '</div>';
        echo '
        <h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Update Sets</h4><br>';
        
        echo '
        <form action="action_update_sets.php" method="post" style=" height: auto; text-align: center; font-family: system-ui;">
        <input type="text" name="newset" placeholder="Enter New Sets"> 
