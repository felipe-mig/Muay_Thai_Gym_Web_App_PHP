...
<body>
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '</div><br>';
            echo '
            <h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Add New User</h4><br>';
            echo '
            <form action="action_adduser.php" method="post" style="text-align: center; font-family: system-ui; height: auto;">
            <br>
            <label>Name</label>
            ...
            <input type="submit" value="Add" id="send-btn"> '; 
            echo '</form>'; 
        }       
        ?>
        <!-- footer -->
