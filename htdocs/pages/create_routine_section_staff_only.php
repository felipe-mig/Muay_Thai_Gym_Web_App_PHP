    ...
    <div class="wrapper">
        ...
        if($_SESSION['validate'] == 'validated'){
            ...
            echo '<div class="arrrowgoback_container">';
                echo '<a id="arrrowgoback" href="dashboard.php"><i class="fa fa-home"></i></a>';
            echo '</div>';
                // Create Routine Form
                echo '<h4 style="text-align: center; font-family: system-ui; font-size: 1.2em;">Create Routine</h4><br>';
            echo '<form action="../pages/actionlink_routine.php" method="post">
                    <input name="exercise" type="text" placeholder="Enter exercise">
                    <input name="equipment" type="text" placeholder="Enter equipment">
                    <input name="series" type="text" placeholder="Enter set">
                    <input name="reps" type="text" placeholder="Enter reps">
                    <div class="login-form-logo"></div>
                    <input type="submit" value="Create" id="send-btn"> 
                    </form>  
            ';
        }
