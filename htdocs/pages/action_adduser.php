...
// print_r($_POST);
$username = $_POST['username']; # ['username'] --> Este es el name='username' que tenemos en el <input> de nuestro Form.
$password = $_POST['password'];
$position = $_POST['position'];                

// $result = insertuser($dbConnect,$username,$password,$position);

$addSuccesfull = insertuser($dbConnect, $username, $password, $position)
...
<body>
<?php
    // Message add successful or add failed
    if ($addSuccesfull) {
        ...
        echo '<p>User successfully added</p><i class="fa fa-check-circle" style="color: green; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
        // EO Message succesfull add
        echo ' <!-- footer -->
        <footer>
     ...
     <!-- </div> EO WRAPPER-->';
        ...
        echo '<div style="display: flex; justify-content: center; align-items: center; height: 50vh; font-family: system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue, sans-serif; color;font-size: 1.1em;">';
        echo '<p>add error!</p><i class="fa fa-times-circle" style="color: red; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
        // EO Error updating
        echo ' <!-- footer -->
        <footer>
