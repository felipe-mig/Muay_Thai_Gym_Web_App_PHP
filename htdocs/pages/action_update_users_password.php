...
// print_r($_POST);
$newpassword = $_POST['newpassword']; # name="" que tenemos en el <input> de nuestro <form>
$userid = $_POST['username']; 
update_user_password($dbConnect, $userid, $newpassword);

// call the function and catch the result for the succsefull or error message
$updateSuccessful = update_user_password($dbConnect, $userid, $newpassword);
...
<?php
    ...
    if ($updateSuccessful) {
        ...
        echo '<p>Password successfully updated</p><i class="fa fa-check-circle" style="color: green; margin-left: 0.25vw; font-size: 1.1em;"></i>';
        echo '</div>';
...
<script>
    function bounce(){
        window.location.href = "update_users_password.php";
    }
