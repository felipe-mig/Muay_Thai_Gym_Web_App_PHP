...
// print_r($_POST);
$newtime = $_POST['newtime']; # name="" que tenemos en el <input> de nuestro <form>
$timeid = $_POST['timeid']; # name="" que tenemos en el <input> con el value="hidden"
update_time($dbConnect, $timeid, $newtime);
